import type { TaskHeaderProps, TaskHeaderReference } from '@open-mercato/cezar-extension-api'
...
export type JiraDraftInput = Pick<TaskHeaderProps, 'task' | 'attention' | 'engine' | 'meta'>
