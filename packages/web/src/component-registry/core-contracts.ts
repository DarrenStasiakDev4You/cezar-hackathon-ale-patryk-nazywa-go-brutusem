import { TaskHeaderMain, TaskMetadata } from '@open-mercato/cezar-extension-api'
 ...
 */
export const CORE_COMPONENT_CONTRACTS: readonly AnyComponentContract[] = [TaskHeaderMain, TaskMetadata]
