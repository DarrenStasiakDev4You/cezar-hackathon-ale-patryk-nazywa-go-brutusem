import { TaskComposer, TaskHeader } from '@open-mercato/cezar-extension-api'
 ...
 * boot.
 *
 * - `task.header@1`: the task header's public model and its title, status and basic
 *   meta, rendered by `RunHeader` (specs `2026-09-19-component-host` and
 *   `2026-09-19-task-header-contract`).
 */
export const CORE_COMPONENT_CONTRACTS: readonly AnyComponentContract[] = [TaskHeader, TaskComposer]
