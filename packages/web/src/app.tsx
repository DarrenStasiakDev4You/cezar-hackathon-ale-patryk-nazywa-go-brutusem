...
export function App(props: {
  ...
  /** The page's workspace-backed component choices, created by `main.tsx`. Omitted (tests) →
   * StoredComponentsProvider creates an in-memory service over its own registry. */
