...
| 3 | 3.1 | Resolve the duplicate implementation and current-base conflict before completion, retaining only work that is still needed after PR #58. | inline | todo | — |
